...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap font-poppins text-[14px] font-normal transition-colors focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 cursor-pointer",
  {
    variants: {
      variant: {
